                  ...
                  <div class='row'>
                    ...
                    <div class='col-xs-12 text-left'>
                      <address class='address-tag'>
                        Due Date: <strong>${
                          data?.dueDate &&
                          moment(new Date(data?.dueDate)).format("DD MMM, YYYY")
                        }</strong>
                      </address>
                    </div>
                    <div class='col-xs-12 text-left'>
                    ...
                    <div class='col-xs-12 text-left'>
                      <address class='address-tag'>
                        Order Date: <strong>${
                          data?.orderDate &&
                          moment(new Date(data?.orderDate)).format(
                            "DD MMM, YYYY"
                          )
                        }</strong>
                      </address>
                    ...
                    <div class='col-xs-12 text-left'>
                      <address class='address-tag'>
                        PO Date: <strong>${
                          data?.poDate &&
                          moment(new Date(data?.poDate)).format("DD MMM, YYYY")
                        }</strong>
                      </address>
                    </div>
                  </div>
  ...
  .map(
    item => `
                <tr>
                  ...
                  <td style='text-align: center; border: 1px solid #e3e3e3; border-collapse: collapse; height: 32px; text-align: right; padding: 5px; color: black; font-weight: 900' colspan='2'>
                    ${item.qty} <br /> Kg
                  </td>
                  <td style='text-align: center; border: 1px solid #e3e3e3; border-collapse: collapse; height: 32px; text-align: right; padding: 5px' colspan='2'>
                    ${item.rate}
                  </td>
                  <td style='text-align: center; border: 1px solid #e3e3e3; border-collapse: collapse; height: 32px; text-align: right; padding: 5px' colspan='2'>
  ...
  .join("")}
            ...
            <div class='row'>
              <div class='col-xs-8 text-left' style="font-size: 11px;color:black; font-weight:900">
                     <div>
                  <br/><br/>
                  Remarks: <br/>${data?.remarksItems?.description
                    .split("\n")
                    .join("<br/>")}<br/>
                </div>
              </div>
